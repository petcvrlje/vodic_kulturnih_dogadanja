...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        // If your application supports background execution, this jjmethod is called instead of applicationWillTerminate: when the user quits.
    }
...
@available(iOS 10, *) extension AppDelegate: UNUserNotificationCenterDelegate {
    func userNotificationCenter(_ center: UNUserNotificationCenter, willPresent notification: UNNotification, withCompletionHandler completionHandler: @escaping (UNNotificationPresentationOptions) -> Void) {
        let userInfo = notification.request.content.userInfo
        
        //Messaging.messaging().appDidRecieveMessage(userInfo)
